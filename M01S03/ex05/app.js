...
console.warn(
  `Afiseaz propozitia "Sunt xxx si acum invat Javascript." Nu folosi valoarea din arrayul de skills.`,
);
...
console.log(`Am ${person.friends.length} prieteni: ${person.friends[0].name},
...
console.log(
  `
  Ma numesc ${person.name} ${person.surname} si vreau sa invat javascript.
  `,
);
...
console.log(
  `
    Numele meu este ${person.name} ${person.surname}, am ${person.age} si ${person.friends.length} prieteni.
  `,
);
